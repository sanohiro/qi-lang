...
### 実装状況サマリー
- ✅ **コア機能（約70%完成）**: 8つの特殊形式、パイプライン、パターンマッチング、モジュールシステム基盤、loop/recur、マクロシステム完全実装
- ✅ **組み込み関数（70個）**: 算術、比較、リスト、文字列、マップ、述語、論理、高階関数、エラー処理、状態管理、メタプログラミング
...
- 🚧 **未実装の重要機能**: 並行処理、@（derefの短縮形）、標準モジュール群（str/csv/regex/http等）
