...
### 実装状況サマリー
- ✅ **コア機能（約60%完成）**: 8つの特殊形式、パイプライン、パターンマッチング、モジュールシステム基盤、loop/recur、マクロシステム
- ✅ **組み込み関数（62個）**: 算術、比較、リスト、文字列、マップ、述語、論理、高階関数、エラー処理
...
- 🚧 **未実装の重要機能**: 並行処理、状態管理、uvar/variable（マクロの衛生性）、標準モジュール群（str/csv/regex/http等）
