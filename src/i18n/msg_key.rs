...
pub enum MsgKey {
    ...
    ZipCreateFileFailed,      // {0}: failed to create zip file '{1}': {2}
    ...
    WsConnectionAlreadyClosed, // WebSocket connection is already closed
    WsFailedToConnect,         // Failed to connect to WebSocket server: {0}
    ...
    StaticFileMetadataFailed,       // Failed to read file metadata: {0}
    ...
    StaticFileFailedToGetCwd,       // Failed to get current directory: {0}
    StaticFileInvalidFilePath,      // Invalid file path: {0}
    StaticFileInvalidEncoding,      // Invalid file path encoding
    StaticFileFailedToCanonicalize, // Failed to canonicalize directory: {0}
